...
rob_slots = os.getenv("VANADIS_ROB_SLOTS", 256)
retires_per_cycle = os.getenv("VANADIS_RETIRES_PER_CYCLE", 6)
issues_per_cycle = os.getenv("VANADIS_ISSUES_PER_CYCLE", 6)
decodes_per_cycle = os.getenv("VANADIS_DECODES_PER_CYCLE", 6)

...
rob_slots = int(os.getenv("VANADIS_ROB_SLOTS", 64))
retires_per_cycle = int(os.getenv("VANADIS_RETIRES_PER_CYCLE", 2))
issues_per_cycle = int(os.getenv("VANADIS_ISSUES_PER_CYCLE", 2))
decodes_per_cycle = int(os.getenv("VANADIS_DECODES_PER_CYCLE", 2))

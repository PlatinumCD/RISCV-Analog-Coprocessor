...
lsq_ld_entries = int(os.getenv("VANADIS_LSQ_LD_ENTRIES", 192))
lsq_st_entries = int(os.getenv("VANADIS_LSQ_ST_ENTRIES", 128))

rob_slots = int(os.getenv("VANADIS_ROB_SLOTS", 512))
retires_per_cycle = int(os.getenv("VANADIS_RETIRES_PER_CYCLE", 8))
issues_per_cycle = int(os.getenv("VANADIS_ISSUES_PER_CYCLE", 12))
...
integer_arith_units = int(os.getenv("VANADIS_INTEGER_ARITH_UNITS", 12))
fp_arith_cycles = int(os.getenv("VANADIS_FP_ARITH_CYCLES", 6))
fp_arith_units = int(os.getenv("VANADIS_FP_ARITH_UNITS", 12))

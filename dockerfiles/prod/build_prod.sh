...
# SST-CrossSim
export SST_CROSSSIM_IMAGE_NAME=analog-sst-crosssim
...
export RISCV_MUSL_IMAGE_NAME=analog-riscv-musl
...
export LLVM_RISCV_MUSL_IMAGE_NAME=analog-llvm-riscv-musl

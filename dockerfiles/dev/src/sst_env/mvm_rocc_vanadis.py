...
cross_sim_json = "cross_sim_params.json"
dir_path = os.path.dirname(os.path.realpath(__file__))
full_cross_sim_json =  os.getenv("CROSS_SIM_JSON", dir_path + "/small/" + testDir + "/" + cross_sim_json)
...
arrayParams = {
    ...
    "verbose" : 20,
    "mmioAddr" : 0,
    "CrossSimJSON" : full_cross_sim_json
}
